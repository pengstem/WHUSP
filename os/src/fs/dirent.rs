...
pub(super) fn write_dir_entries(
    ...
    write_dir_entries_with_offset_base(entries, offset, 0, buf)
}

pub(super) fn write_dir_entries_with_offset_base(
    entries: &[RawDirEntry],
    offset: u64,
    d_off_base: u64,
    buf: &mut [u8],
    ...
    while entry_index < entries.len() {
        ...
        entry_buf[8..16].copy_from_slice(&(d_off as i64).to_ne_bytes());
