...
pub(crate) enum ProfilePoint {
    ...
    SysWrite,
    VfsLookup,
    VfsLookupPathComponents,
    VfsLookupVisiblePath,
    VfsLookupDentry,
    VfsLookupBackend,
...
pub(crate) struct KernelPerfSnapshot {
    ...
    pub(crate) page_cache_generation_epochs_begun: usize,
    pub(crate) page_cache_generation_epochs_finished: usize,
    pub(crate) page_cache_generation_retries: usize,
    pub(crate) page_cache_stale_fill_drops: usize,
    pub(crate) page_cache_stale_install_retries: usize,
    pub(crate) page_cache_capacity_rejects: usize,
    pub(crate) mmap_clean_page_cache_hits: usize,
    ...
    pub(crate) ext4_write_plan_attempts: usize,
    pub(crate) ext4_write_plan_prepared: usize,
    pub(crate) ext4_write_plan_executed: usize,
    pub(crate) ext4_write_plan_fallbacks: usize,
    pub(crate) ext4_write_plan_alias_busy: usize,
    pub(crate) ext4_write_plan_data_runs: usize,
    pub(crate) ext4_write_plan_data_blocks: usize,
    pub(crate) ext4_write_plan_invalidated_aliases: usize,
    pub(crate) ext4_write_plan_executed_bytes: usize,
    pub(crate) ext4_write_plan_rmw_read_calls: usize,
    pub(crate) ext4_write_plan_rmw_read_blocks: usize,
    pub(crate) ext4_write_plan_rmw_read_bytes: usize,
...
mod enabled {
    ...
    static EXT4_WRITE_PLAN_ATTEMPTS: AtomicUsize = AtomicUsize::new(0);
    static EXT4_WRITE_PLAN_PREPARED: AtomicUsize = AtomicUsize::new(0);
    static EXT4_WRITE_PLAN_EXECUTED: AtomicUsize = AtomicUsize::new(0);
    static EXT4_WRITE_PLAN_FALLBACKS: AtomicUsize = AtomicUsize::new(0);
    static EXT4_WRITE_PLAN_ALIAS_BUSY: AtomicUsize = AtomicUsize::new(0);
    static EXT4_WRITE_PLAN_DATA_RUNS: AtomicUsize = AtomicUsize::new(0);
    static EXT4_WRITE_PLAN_DATA_BLOCKS: AtomicUsize = AtomicUsize::new(0);
    static EXT4_WRITE_PLAN_INVALIDATED_ALIASES: AtomicUsize = AtomicUsize::new(0);
    static EXT4_WRITE_PLAN_EXECUTED_BYTES: AtomicUsize = AtomicUsize::new(0);
    static EXT4_WRITE_PLAN_RMW_READ_CALLS: AtomicUsize = AtomicUsize::new(0);
    static EXT4_WRITE_PLAN_RMW_READ_BLOCKS: AtomicUsize = AtomicUsize::new(0);
    static EXT4_WRITE_PLAN_RMW_READ_BYTES: AtomicUsize = AtomicUsize::new(0);
    ...
    static TIME_STATS: [TimeStat; PROFILE_POINT_COUNT] = [
        ...
        TimeStat::new("vfs_lookup_path_components"),
        TimeStat::new("vfs_lookup_visible_path"),
    ...
    pub(crate) fn record_ext4_write_plan_prepared(
        ...
        EXT4_WRITE_PLAN_PREPARED.fetch_add(1, Ordering::Relaxed);
        EXT4_WRITE_PLAN_DATA_RUNS.fetch_add(data_runs, Ordering::Relaxed);
        EXT4_WRITE_PLAN_DATA_BLOCKS.fetch_add(data_blocks, Ordering::Relaxed);
    ...
    pub(crate) fn record_ext4_write_plan_executed(
        ...
        EXT4_WRITE_PLAN_EXECUTED.fetch_add(1, Ordering::Relaxed);
        EXT4_WRITE_PLAN_EXECUTED_BYTES.fetch_add(bytes, Ordering::Relaxed);
        EXT4_WRITE_PLAN_DIRECT_IO_CALLS.fetch_add(direct_calls, Ordering::Relaxed);
        EXT4_WRITE_PLAN_DIRECT_IO_BLOCKS.fetch_add(direct_blocks, Ordering::Relaxed);
    ...
    pub(crate) fn snapshot() -> KernelPerfSnapshot {
        KernelPerfSnapshot {
            ...
            ext4_directory_plan_direct_io_bytes: EXT4_DIRECTORY_PLAN_DIRECT_IO_BYTES
                .load(Ordering::Relaxed),
            ext4_write_plan_attempts: EXT4_WRITE_PLAN_ATTEMPTS.load(Ordering::Relaxed),
            ext4_write_plan_prepared: EXT4_WRITE_PLAN_PREPARED.load(Ordering::Relaxed),
            ext4_write_plan_executed: EXT4_WRITE_PLAN_EXECUTED.load(Ordering::Relaxed),
            ext4_write_plan_fallbacks: EXT4_WRITE_PLAN_FALLBACKS.load(Ordering::Relaxed),
            ext4_write_plan_alias_busy: EXT4_WRITE_PLAN_ALIAS_BUSY.load(Ordering::Relaxed),
            ext4_write_plan_data_runs: EXT4_WRITE_PLAN_DATA_RUNS.load(Ordering::Relaxed),
            ext4_write_plan_data_blocks: EXT4_WRITE_PLAN_DATA_BLOCKS.load(Ordering::Relaxed),
            ext4_write_plan_invalidated_aliases: EXT4_WRITE_PLAN_INVALIDATED_ALIASES
                .load(Ordering::Relaxed),
            ext4_write_plan_executed_bytes: EXT4_WRITE_PLAN_EXECUTED_BYTES.load(Ordering::Relaxed),
            ext4_write_plan_rmw_read_calls: EXT4_WRITE_PLAN_RMW_READ_CALLS.load(Ordering::Relaxed),
            ext4_write_plan_rmw_read_blocks: EXT4_WRITE_PLAN_RMW_READ_BLOCKS
                .load(Ordering::Relaxed),
            ext4_write_plan_rmw_read_bytes: EXT4_WRITE_PLAN_RMW_READ_BYTES.load(Ordering::Relaxed),
            ext4_write_plan_direct_io_calls: EXT4_WRITE_PLAN_DIRECT_IO_CALLS
                .load(Ordering::Relaxed),
            ext4_write_plan_direct_io_blocks: EXT4_WRITE_PLAN_DIRECT_IO_BLOCKS
                .load(Ordering::Relaxed),
    ...
    pub(crate) fn stats_content() -> String {
        ...
        let mut content = format!(
         ...
         page_cache_generation_epochs_begun {}\n\
         page_cache_generation_epochs_finished {}\n\
         page_cache_generation_retries {}\n\
         page_cache_stale_fill_drops {}\n\
         page_cache_stale_install_retries {}\n\
         page_cache_capacity_rejects {}\n\
         mmap_clean_page_cache_hits {}\n\
         ...
         ext4_write_plan_attempts {}\n\
         ext4_write_plan_prepared {}\n\
         ext4_write_plan_executed {}\n\
         ext4_write_plan_fallbacks {}\n\
         ext4_write_plan_alias_busy {}\n\
         ext4_write_plan_data_runs {}\n\
         ext4_write_plan_data_blocks {}\n\
         ext4_write_plan_invalidated_aliases {}\n\
         ext4_write_plan_executed_bytes {}\n\
         ext4_write_plan_rmw_read_calls {}\n\
         ext4_write_plan_rmw_read_blocks {}\n\
         ext4_write_plan_rmw_read_bytes {}\n\
         ...
         futex_bucket_waiter_count_max {}\n",
            ...
            stats.page_cache_generation_epochs_begun,
            stats.page_cache_generation_epochs_finished,
            stats.page_cache_generation_retries,
            stats.page_cache_stale_fill_drops,
            stats.page_cache_stale_install_retries,
            stats.page_cache_capacity_rejects,
            stats.mmap_clean_page_cache_hits,
            ...
            stats.ext4_write_plan_attempts,
            stats.ext4_write_plan_prepared,
            stats.ext4_write_plan_executed,
            stats.ext4_write_plan_fallbacks,
            stats.ext4_write_plan_alias_busy,
            stats.ext4_write_plan_data_runs,
            stats.ext4_write_plan_data_blocks,
            stats.ext4_write_plan_invalidated_aliases,
            stats.ext4_write_plan_executed_bytes,
            stats.ext4_write_plan_rmw_read_calls,
            stats.ext4_write_plan_rmw_read_blocks,
            stats.ext4_write_plan_rmw_read_bytes,
