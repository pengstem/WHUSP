...
pub fn sys_init_module(module_image: *const u8, len: usize, _param_values: *const u8) -> KResult {
...
pub fn sys_finit_module(fd: usize, _param_values: *const u8, _flags: u32) -> KResult {
...
pub fn sys_delete_module(name_ptr: *const u8, _flags: u32) -> KResult {
