...
pub(crate) use pidfd::install_pidfd_for_fanotify;
pub(crate) use pidfd::pidfd_fdinfo;
...
pub use sched::{
    sys_getcpu_ctx, sys_getpriority, sys_sched_get_priority_max, sys_sched_get_priority_min,
    sys_sched_getaffinity_ctx, sys_sched_getattr, sys_sched_getparam, sys_sched_getscheduler,
    sys_sched_rr_get_interval, sys_sched_setaffinity_ctx, sys_sched_setattr, sys_sched_setparam,
