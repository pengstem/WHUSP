#!/usr/bin/env python3
"""Export preliminary contest runner groups and LTP cases as shell scripts."""
...
def prepare_out_dir(path: Path, force: bool) -> None:
    ...
    (path / MARKER_FILE).write_text(
        "Generated by scripts/export_preliminary_contest_case_scripts.py.\n",
        encoding="utf-8",
    )
...
# Common guest-side helpers generated by export_preliminary_contest_case_scripts.py.
...
# Generated by export_preliminary_contest_case_scripts.py.
# arch={arch}
# libc={libc_label(libc_root)}
# group={test_name(script)}
...
```sh
python3 scripts/export_preliminary_contest_case_scripts.py --force
```
"""
